...
public class SuperEqualsHashCodeIntegrationTest extends
	...
	public void createEqualsHashCode() throws Exception {
		...
		String expectedText = readFile("Expected_SuperEqualsHashCode.txt");
	...
	public void createEqualsHashCodeForInterfaceClass() throws Exception {
		...
		String editorText = cutEditor.getText();
		String expectedText = readFile("Expected_SuperEqualsHashCodeForInterfaceClass.txt");
		assertThat(editorText, is(expectedText));
	}
